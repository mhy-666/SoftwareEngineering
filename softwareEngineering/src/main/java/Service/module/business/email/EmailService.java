package Service.module.business.email;

import Service.common.domain.PageResultDTO;
import Service.common.domain.ResponseDTO;
import Service.module.business.email.domain.dto.EmailConfigDTO;
import Service.module.business.email.domain.dto.EmailDTO;
import Service.module.business.email.domain.dto.EmailQueryDTO;
import Service.module.business.email.domain.dto.EmailVO;
import Service.module.business.email.domain.entity.EmailEntity;
import Service.util.SmartBeanUtil;
import Service.util.SmartPageUtil;
import Service.util.SmartSendMailUtil;
